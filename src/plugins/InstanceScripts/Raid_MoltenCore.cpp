...
class MoltenGiantAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(MoltenGiantAI, AICreatureScript);
		MoltenGiantAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class MoltenDestroyerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(MoltenDestroyerAI, AICreatureScript);
		MoltenDestroyerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class FirelordAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(FirelordAI, AICreatureScript);
		FirelordAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class LavaAnnihilatorAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(LavaAnnihilatorAI, AICreatureScript);
		LavaAnnihilatorAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class AncientCoreHoundAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(AncientCoreHoundAI, AICreatureScript);
		AncientCoreHoundAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class LavaSurgerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(LavaSurgerAI, AICreatureScript);
		LavaSurgerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class FlameImpAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(FlameImpAI, AICreatureScript);
		FlameImpAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class CoreHoundAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(CoreHoundAI, AICreatureScript);
		CoreHoundAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class LavaReaverAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(LavaReaverAI, AICreatureScript);
		LavaReaverAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class LavaElementalAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(LavaElementalAI, AICreatureScript);
		LavaElementalAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class FlameguardAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(FlameguardAI, AICreatureScript);
		FlameguardAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class FirewalkerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(FirewalkerAI, AICreatureScript);
		FirewalkerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
{
		AI_CREATURE_SCRIPT_FUNCTION(LucifronAI, MoonScriptBossAI);
...
class FlamewakerProtectorAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(FlamewakerProtectorAI, AICreatureScript);
		FlamewakerProtectorAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
{
		AI_CREATURE_SCRIPT_FUNCTION(MagmadarAI, MoonScriptBossAI);
...
{
		AI_CREATURE_SCRIPT_FUNCTION(GehennasAI, MoonScriptBossAI);
...
class FlamewakerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(FlamewakerAI, AICreatureScript);
		FlamewakerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
{
		AI_CREATURE_SCRIPT_FUNCTION(GarrAI, MoonScriptBossAI);
...
class FireswornAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(FireswornAI, AICreatureScript);
		FireswornAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
			mGarr = NULL;
...
{
		AI_CREATURE_SCRIPT_FUNCTION(BaronGeddonAI, MoonScriptBossAI);
...
void SpellFunc_ShazzrahBlinkArcaneExplosions(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);

class ShazzrahAI : public MoonScriptBossAI
{
		AI_CREATURE_SCRIPT_FUNCTION(ShazzrahAI, MoonScriptBossAI);
...
{
		AI_CREATURE_SCRIPT_FUNCTION(GolemaggAI, MoonScriptBossAI);
