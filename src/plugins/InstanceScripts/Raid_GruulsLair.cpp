...
void SpellFunc_LairBrute_Charge(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);

class LairBruteAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(LairBruteAI, AICreatureScript);
		LairBruteAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class GronnPriestAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(GronnPriestAI, AICreatureScript);
		GronnPriestAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
void SpellFunc_Maulgar_Enrage(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);
...
{
		AI_CREATURE_SCRIPT_FUNCTION(HighKingMaulgarAI, MoonScriptBossAI);
...
class KigglerTheCrazedAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(KigglerTheCrazedAI, AICreatureScript);
		KigglerTheCrazedAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class BlindeyeTheSeerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(BlindeyeTheSeerAI, AICreatureScript);
		BlindeyeTheSeerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class OlmTheSummonerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(OlmTheSummonerAI, AICreatureScript);
		OlmTheSummonerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class WildFelStalkerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(WildFelStalkerAI, AICreatureScript);
		WildFelStalkerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class KroshFirehandAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(KroshFirehandAI, AICreatureScript);
		KroshFirehandAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
			//spells
...
void SpellFunc_Gruul_GroundSlam(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);
void SpellFunc_Gruul_Stoned(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);
void SpellFunc_Gruul_Shatter(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);

class GruulTheDragonkillerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(GruulTheDragonkillerAI, AICreatureScript);
		GruulTheDragonkillerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
