...
/////// Trash AIs
/*
class TemplateAI : public AICreatureScript
{
	AI_CREATURE_SCRIPT_FUNCTION(TemplateAI, AICreatureScript);
	TemplateAI(Creature* pCreature) : AICreatureScript(pCreature)
	{
	}
};
*/
...
class DragonTurtleAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(DragonTurtleAI, AICreatureScript);
		DragonTurtleAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class LeviathanAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(LeviathanAI, AICreatureScript);
		LeviathanAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class MutantWarHoundAI : public AICreatureScript
{
...
void SpellFunc_Charge(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);

class ShadowmoonRidingHoundAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(ShadowmoonRidingHoundAI, AICreatureScript);
		ShadowmoonRidingHoundAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class SisterOfPleasureAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(SisterOfPleasureAI, AICreatureScript);
		SisterOfPleasureAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class SisterOfPainAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(SisterOfPainAI, AICreatureScript);
		SisterOfPainAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class PriestessOfDementiaAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(PriestessOfDementiaAI, AICreatureScript);
		PriestessOfDementiaAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class PriestessOfDelightAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(PriestessOfDelightAI, AICreatureScript);
		PriestessOfDelightAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class IllidariNightlordAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(IllidariNightlordAI, AICreatureScript);
		IllidariNightlordAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
void SpellFunc_RapidShot(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);

class IllidariHeartseekerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(IllidariHeartseekerAI, AICreatureScript);
		IllidariHeartseekerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class IllidariFearbringerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(IllidariFearbringerAI, AICreatureScript);
		IllidariFearbringerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class IllidariDefilerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(IllidariDefilerAI, AICreatureScript);
		IllidariDefilerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class IllidariCenturionAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(IllidariCenturionAI, AICreatureScript);
		IllidariCenturionAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
void SpellFunc_Gouge(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);

class IllidariBoneslicerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(IllidariBoneslicerAI, AICreatureScript);
		IllidariBoneslicerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class AshtongueBattlelordAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(AshtongueBattlelordAI, AICreatureScript);
		AshtongueBattlelordAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class AshtongueDefenderAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(AshtongueDefenderAI, AICreatureScript);
		AshtongueDefenderAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class AshtongueElementalistAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(AshtongueElementalistAI, AICreatureScript);
		AshtongueElementalistAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class AshtongueMysticAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(AshtongueMysticAI, AICreatureScript);
		AshtongueMysticAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class AshtonguePrimalistAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(AshtonguePrimalistAI, AICreatureScript);
		AshtonguePrimalistAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class AshtongueRogueAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(AshtongueRogueAI, AICreatureScript);
		AshtongueRogueAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class AshtongueSpiritbinderAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(AshtongueSpiritbinderAI, AICreatureScript);
		AshtongueSpiritbinderAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class AshtongueStalkerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(AshtongueStalkerAI, AICreatureScript);
		AshtongueStalkerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class AshtongueStormcallerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(AshtongueStormcallerAI, AICreatureScript);
		AshtongueStormcallerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class BonechewerBehemothAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(BonechewerBehemothAI, AICreatureScript);
		BonechewerBehemothAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class BonechewerBladeFuryAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(BonechewerBladeFuryAI, AICreatureScript);
		BonechewerBladeFuryAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class BonechewerBloodProphetAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(BonechewerBloodProphetAI, AICreatureScript);
		BonechewerBloodProphetAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class BonechewerBrawlerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(BonechewerBrawlerAI, AICreatureScript);
		BonechewerBrawlerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class BonechewerCombatantAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(BonechewerCombatantAI, AICreatureScript);
		BonechewerCombatantAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class BonechewerShieldDiscipleAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(BonechewerShieldDiscipleAI, AICreatureScript);
		BonechewerShieldDiscipleAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class BonechewerSpectatorAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(BonechewerSpectatorAI, AICreatureScript);
		BonechewerSpectatorAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class BonechewerTaskmasterAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(BonechewerTaskmasterAI, AICreatureScript);
		BonechewerTaskmasterAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class BonechewerWorkerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(BonechewerWorkerAI, AICreatureScript);
		BonechewerWorkerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class CharmingCourtesanAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(CharmingCourtesanAI, AICreatureScript);
		CharmingCourtesanAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class CoilskarGeneralAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(CoilskarGeneralAI, AICreatureScript);
		CoilskarGeneralAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class CoilskarHarpoonerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(CoilskarHarpoonerAI, AICreatureScript);
		CoilskarHarpoonerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class CoilskarSeacallerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(CoilskarSeacallerAI, AICreatureScript);
		CoilskarSeacallerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class CoilskarSoothsayerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(CoilskarSoothsayerAI, AICreatureScript);
		CoilskarSoothsayerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class CoilskarWranglerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(CoilskarWranglerAI, AICreatureScript);
		CoilskarWranglerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class DragonmawSkyStalkerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(DragonmawSkyStalkerAI, AICreatureScript);
		DragonmawSkyStalkerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class DragonmawWindReaverAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(DragonmawWindReaverAI, AICreatureScript);
		DragonmawWindReaverAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class DragonmawWyrmcallerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(DragonmawWyrmcallerAI, AICreatureScript);
		DragonmawWyrmcallerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class EnslavedServantAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(EnslavedServantAI, AICreatureScript);
		EnslavedServantAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class HandOfGorefiendAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(HandOfGorefiendAI, AICreatureScript);
		HandOfGorefiendAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class IllidariArchonAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(IllidariArchonAI, AICreatureScript);
		IllidariArchonAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class IllidariAssassinAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(IllidariAssassinAI, AICreatureScript);
		IllidariAssassinAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class IllidariBattlemageAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(IllidariBattlemageAI, AICreatureScript);
		IllidariBattlemageAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
			switch(RandomUInt(1))
			{
				case 0:
...
class IllidariBloodLordAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(IllidariBloodLordAI, AICreatureScript);
		IllidariBloodLordAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
void SpellFunc_Whirlwind(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);

class ImageOfDementiaAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(ImageOfDementiaAI, AICreatureScript);
		ImageOfDementiaAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class ShadowmoonBloodMageAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(ShadowmoonBloodMageAI, AICreatureScript);
		ShadowmoonBloodMageAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class ShadowmoonChampionAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(ShadowmoonChampionAI, AICreatureScript);
		ShadowmoonChampionAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
void SpellFunc_RaiseDead(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);

class ShadowmoonDeathshaperAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(ShadowmoonDeathshaperAI, AICreatureScript);
		ShadowmoonDeathshaperAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
void SpellFunc_RaiseDead(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType)
{
	...
	if(pDeathshaper != NULL)
	{
		...
		AICreatureScript* pAI = pDeathshaper->SpawnCreature(23371, pTarget->GetPositionX(), pTarget->GetPositionY(), pTarget->GetPositionZ(), pTarget->GetOrientation());
		if(pAI != NULL)
		{
...
class ShadowmoonFallenAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(ShadowmoonFallenAI, AICreatureScript);
		ShadowmoonFallenAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class ShadowmoonHoundmasterAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(ShadowmoonHoundmasterAI, AICreatureScript);
		ShadowmoonHoundmasterAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class ShadowmoonReaverAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(ShadowmoonReaverAI, AICreatureScript);
		ShadowmoonReaverAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class ShadowmoonSoldierAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(ShadowmoonSoldierAI, AICreatureScript);
		ShadowmoonSoldierAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
void SpellFunc_DefensiveStance(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);
void SpellFunc_BerserkerStance(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);

class ShadowmoonWeaponMasterAI : public MoonScriptBossAI
{
		AI_CREATURE_SCRIPT_FUNCTION(ShadowmoonWeaponMasterAI, MoonScriptBossAI);
...
class SpellboundAttendantAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(SpellboundAttendantAI, AICreatureScript);
		SpellboundAttendantAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class TempleConcubineAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(TempleConcubineAI, AICreatureScript);
		TempleConcubineAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
void SpellFunc_StormBlink(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);

class StormFuryAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(StormFuryAI, AICreatureScript);
		StormFuryAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class AqueousSurgerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(AqueousSurgerAI, AICreatureScript);
		AqueousSurgerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class AqueousSpawnAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(AqueousSpawnAI, AICreatureScript);
		AqueousSpawnAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
void SpellFunc_SpawnAqueousSpawn(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);

class AqueousLordAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(AqueousLordAI, AICreatureScript);
		AqueousLordAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
void SpellFunc_SpawnAqueousSpawn(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType)
{
	...
	{
		AICreatureScript* pSpawnAI = pAqueousLordAI->SpawnCreature(CN_AQUEOUS_SPAWN);
		if(pSpawnAI != NULL)
		{
...
class PromenadeSentinelAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(PromenadeSentinelAI, AICreatureScript);
		PromenadeSentinelAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class AngeredSoulFragmentAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(AngeredSoulFragmentAI, AICreatureScript);
		AngeredSoulFragmentAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class AshtongueFeralSpiritAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(AshtongueFeralSpiritAI, AICreatureScript);
		AshtongueFeralSpiritAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
		}
};
...
class EnslavedSoulAI : public AICreatureScript
{
...
class HungeringSoulFragmentAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(HungeringSoulFragmentAI, AICreatureScript);
		HungeringSoulFragmentAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class ShadowyConstructAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(ShadowyConstructAI, AICreatureScript);
		ShadowyConstructAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class SufferingSoulFragmentAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(SufferingSoulFragmentAI, AICreatureScript);
		SufferingSoulFragmentAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class VangefulSpiritAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(VangefulSpiritAI, AICreatureScript);
		VangefulSpiritAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class WrathboneFlayerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(WrathboneFlayerAI, AICreatureScript);
		WrathboneFlayerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class EssenceOfSufferingAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(EssenceOfSufferingAI, AICreatureScript);
		EssenceOfSufferingAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
		...
		void AIUpdate()
		{
			...
			if(GetHealthPercent() <= 1)
			{
				...
				AICreatureScript* mRoS = GetNearestCreature(22856);
...
class EssenceOfDesireAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(EssenceOfDesireAI, AICreatureScript);
		EssenceOfDesireAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class EssenceOfAngerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(EssenceOfAngerAI, AICreatureScript);
		EssenceOfAngerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class ReliquaryOfSoulsAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(ReliquaryOfSoulsAI, AICreatureScript);
		ReliquaryOfSoulsAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
				...
				case 5:
					{
						...
						if(IsTimerFinished(mEnslavedSoulTimer) && !SpawnedEnsalvedSoul)
						{
							...
							AICreatureScript* pSpawnedEnsalvedSoul;
							for(int i = 0; i < 10; i++)
							{
		...
		AICreatureScript*	mEoS;
		AICreatureScript*	mEoD;
		AICreatureScript*	mEoA;
...
class GathiosAI : public AICreatureScript
{
	public:
		AI_CREATURE_SCRIPT_FUNCTION(GathiosAI, AICreatureScript);
		GathiosAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class VerasAI : public AICreatureScript
{
	public:
		AI_CREATURE_SCRIPT_FUNCTION(VerasAI, AICreatureScript);
		VerasAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class ZerevorAI : public AICreatureScript
{
	public:
		AI_CREATURE_SCRIPT_FUNCTION(ZerevorAI, AICreatureScript);
		ZerevorAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class MalandeAI : public AICreatureScript
{
	public:
		AI_CREATURE_SCRIPT_FUNCTION(MalandeAI, AICreatureScript);
		MalandeAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class UnselectableTriggerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(UnselectableTriggerAI, AICreatureScript);
		UnselectableTriggerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class GenericTriggerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(GenericTriggerAI, AICreatureScript);
		GenericTriggerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
			SetCanMove(false);
...
class EyeBeamTriggerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(EyeBeamTriggerAI, AICreatureScript);
		EyeBeamTriggerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
			_unit->SetUInt64Value(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_ATTACKABLE_2);
...
class ShadowDemonAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(ShadowDemonAI, AICreatureScript);
		ShadowDemonAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
void SpellFunc_Parasitic(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);

class ParasiticShadowfiendAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(ParasiticShadowfiendAI, AICreatureScript);
		ParasiticShadowfiendAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
...
class SCRIPT_DECL AkamaGossip : public GossipScript
{
	public:
		void GossipHello(Object* pObject, Player* pPlayer)
		{
			...
			AICreatureScript* pAI = TO< AICreatureScript* >(pAIOwner->GetScript());
			GossipMenu* Menu;
...
{
		AI_CREATURE_SCRIPT_FUNCTION(AkamaAI, MoonScriptBossAI);
		...
		void IllidanDialogEvent()
		{
			if(mIllidanAI == NULL)
			{
				...
				{
					mIllidanAI = TO< AICreatureScript* >(pIllidan->GetScript());
				}
			}
		...
		// AIs
		AICreatureScript*	mIllidanAI;
		AICreatureScript*	mUdaloAI;
		AICreatureScript*	mOlumAI;
...
{
		AI_CREATURE_SCRIPT_FUNCTION(MaievAI, MoonScriptBossAI);
...
void SpellFunc_Illidan_Parasitic(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);

class IllidanStormrageAI : public MoonScriptBossAI
{
		AI_CREATURE_SCRIPT_FUNCTION(IllidanStormrageAI, MoonScriptBossAI);
		...
		void PhaseOne()
		{
			...
			{
				AICreatureScript* pAI = SpawnCreature(CN_FACE_TRIGGER, 677.399963f, 305.545044f, 353.192169f, false);
				if(pAI != NULL)
				{
		...
		bool SpawnMaiev()	// this doesn't have collision checks! so keep in mind that Maiev can be spawned behind walls!
		{
			...
			AICreatureScript* pMaievAI = SpawnCreature(CN_MAIEV, newposx, newposy, _unit->GetPositionZ() + 0.5f, 2.177125f);
			if(pMaievAI == NULL)
			{
		...
		void MaievScene()	// thinking about converting Maiev's functions to AICreatureScript functions
		{
			mTimeLeft -= mAIUpdateFrequency;
			if(mTimeLeft > 0)
				return;
				...
				if(GetRangeToUnit(pTarget) <= 80.0f)
				{
					...
					if(mFlameBurstTimer <= 0)
					{
						...
						for(set< Object* >::iterator itr = _unit->GetInRangePlayerSetBegin(); itr != _unit->GetInRangePlayerSetEnd(); ++itr)
						{
							...
							AICreatureScript* pAI = SpawnCreature(CN_FLAME_BURST, (*itr)->GetPositionX(), (*itr)->GetPositionY(), (*itr)->GetPositionZ(), 0, true);
		...
		// Phase 2 variables
		AICreatureScript*	mFoA1;
		AICreatureScript*	mFoA2;
...
class CageTrapTriggerAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(CageTrapTriggerAI, AICreatureScript);
		CageTrapTriggerAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
			_unit->SetUInt64Value(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE);
		...
		void AIUpdate()
		{
			...
			if(pIllidan != NULL)
			{
				...
				if(mTriggerAIList.size() == 0 && pIllidan->isAlive() && GetRangeToUnit(pIllidan) <= 5.0f && !pAI->IsCasting())
				{
					for(int i = 0; i < 8; ++i)
					{
						AICreatureScript* pTriggerAI = SpawnCreature(CN_CAGE_TRAP_TRIGGER, _unit->GetPositionX() + PositionAdds[i][0], _unit->GetPositionY() + PositionAdds[i][1], _unit->GetPositionZ(), _unit->GetOrientation());
						if(pTriggerAI != NULL)
						{
				...
				else if(pIllidan->isAlive() && !mHasTrapped && mTriggerAIList.size() != 0)
				{
					...
					{
						AICreatureScript* pTriggerAI1 = mTriggerAIList[i];
						AICreatureScript* pTriggerAI2 = mTriggerAIList[mTriggerAIList.size() - i - 1];
				...
				else if(mHasTrapped || !pIllidan->isAlive())
				{
					...
					{
						AICreatureScript* pTriggerAI = mTriggerAIList[i];
		...
		std::vector<AICreatureScript*>	mTriggerAIList;
		bool								mIsActivated;
		bool								mHasTrapped;
};
...
class DranaeiSpiritAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(DranaeiSpiritAI, AICreatureScript);
		DranaeiSpiritAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
			Despawn(45000);
			SetCanEnterCombat(false);
			_unit->m_noRespawn = true;
...
void SpellFunc_FlameOfAzzinothFlameBlast(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);
void SpellFunc_FlameOfAzzinothCharge(SpellDesc* pThis, AICreatureScript* pCreatureAI, Unit* pTarget, TargetType pType);

class FlameOfAzzinothAI : public AICreatureScript
{
		AI_CREATURE_SCRIPT_FUNCTION(FlameOfAzzinothAI, AICreatureScript);
		FlameOfAzzinothAI(Creature* pCreature) : AICreatureScript(pCreature)
		{
