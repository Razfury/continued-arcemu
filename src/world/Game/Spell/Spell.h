...
enum procFlags
{
    ...
    PROC_ON_CRIT_HIT_RECEIVED			= 0x8,			//8
    PROC_ON_CAST_SPELL					= 0x10,			//16
    PROC_ON_PHYSICAL_ATTACK_RECEIVED	= 0x20,			//32
    PROC_ON_RANGED_ATTACK				= 0x40,			//64
    PROC_ON_RANGED_CRIT_ATTACK			= 0x80,			//128
    PROC_ON_PHYSICAL_ATTACK				= 0x100,		//256
    PROC_ON_MELEE_ATTACK_RECEIVED		= 0x200,		//512
    PROC_ON_SPELL_HIT					= 0x400,		//1024
    PROC_ON_RANGED_CRIT_ATTACK_RECEIVED	= 0x800,		//2048
    PROC_ON_CRIT_ATTACK					= 0x1000,		//4096
    PROC_ON_RANGED_ATTACK_RECEIVED		= 0x2000,		//8192
    PROC_ON_PRE_DISPELL_AURA_RECEIVED	= 0x4000,		//16384
    PROC_ON_SPELL_LAND_RECEIVED			= 0x8000,		//32768
    PROC_ON_CAST_SPECIFIC_SPELL			= 0x10000,		//65536
    PROC_ON_SPELL_HIT_RECEIVED			= 0x20000,		//131072
    PROC_ON_SPELL_CRIT_HIT_RECEIVED		= 0x40000,		//262144
    PROC_ON_TARGET_DIE					= 0x80000,		//524288
    PROC_ON_ANY_DAMAGE_RECEIVED			= 0x100000,		//1048576
    ...
    PROC_ON_RESIST_RECEIVED				= 0x1000000,	//16777216
    PROC_ON_DODGE_RECEIVED				= 0x2000000,	//33554432
    ...
    PROC_ON_BLOCK_RECEIVED				= 0x20000000,	//536870912
